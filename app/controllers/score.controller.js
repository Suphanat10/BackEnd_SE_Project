    ...
    lesson_arr.map((lesson) => {
      lesson.course_exam.map((exam) => {
        ...
        exam.course_exam_problem.map((problem) => {
          //รตรวจสอบว่ามีข้อมูล reg_exam_ans ใน problem หรือไม่ ถ้ามีก็จะกำหนดค่า problem.reg_exam_ans ให้เป็นข้อมูลแรกในอาเรย์ problem.reg_exam_ans แต่ถ้าไม่มีข้อมูลก็จะกำหนดค่า problem.reg_exam_ans เป็น null
